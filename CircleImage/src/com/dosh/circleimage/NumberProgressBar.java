...
import static com.dosh.circleimage.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.dosh.circleimage.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int textVisible = attributes.getInt(R.styleable.NumberProgressBar_progress_text_visibility,
    ...
    private void calculateDrawRectF() {
        ...
        final float unreachedBarStart = mDrawTextStart + mDrawTextWidth + mOffset;
